...
<body onLoad="document.subscribeForm.user.focus()" leftmargin="0" rightmargin="0" topmargin="0" bottommargin="0"<?=($error!=""?'onload="alert(\'' . $error . '\')"':'')?>> 
		  ...
		  <tr>
		   <td>
			<table align="center" height="90%" >
				<form name="invoiceForm" method="post" action="invoice.php"  onSubmit="this.submitbutton.disabled=true;">
					<tr>
						<td colspan="2" align="center" height="10" valign="middle" class="error">&nbsp;</td>
					</tr>
					<tr>
						<td colspan="2" align="center" height="20" valign="middle" class="error"><b>Please enter al required fields for the invoice</b></td>
					</tr>
					<tr>
						<td colspan="2" class="error" id="error" height="50" align="center"><?=$error?></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<input type="text" name="mail" maxlength="50" value="<?=$mail?>">
						</td>
					</tr>
					<tr>
						<td align="right" style="padding-right:10px;">
						...
						<td>
							<input type="text" name="company" maxlength="50" value="<?=$company?>">
						</td>
					</tr>
					<tr>
						<td align="right" style="padding-right:10px;">
					...
					<tr>
						...
						<td>
							<select name="country" style="width:146"> 
								<option value=""></option>
					...
					<tr>
						...
						<td height="100%" valign="top">
							<input name="submitbutton" type="submit" value="Connect" <?=(isset($_SESSION['PORTAL']['preview'])?"disabled":"")?>>
						</td>
					</tr>
				</form>
			</table>
